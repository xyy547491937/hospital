...
<div>	<!-- <div style="background-color: #FFFFFF;"> -->
		<div style="z-index:-1;" >
			<video  id="myvideo" :src="videoSrc" :poster="videoImg" :muted="muteStatus" :autoplay="playStatus" class="videostyle" ></video>
			...
			<!-- <span class="ico ico-video"  :class="{ hide: isPlay }"></span> -->
		</div>
