<template>
    <div id="info">
             ...
             <div class="author">
                 ...
                 <div class="fr follow-box">
                     <div class="follow-text">
                        <span @click="follow(item,1)" v-show="!item.isFollow">+关注</span>
                        <span @click="follow(item,-1)" v-show="item.isFollow">已关注</span>
                     </div>
                 </div>
             </div>
        </div>
        <div class="seemore" v-if="total>1" @click="toDiaryBook(item)">
            ...
            <span class="moretext"  >查看其余{{total-1}}篇日记</span>
        ...
        <div class="remain-box">
            <div class="remain" v-if="total>1" @click="toDiaryBook(item)">
              <span class="remain-text">查看其余{{total-1}}篇日记 </span>
        ...
        <div class="box comment">
            ...
            <div class="" style="font-size:24rpx;color:#333;" v-show="comments && comments.length==0">暂无评论</div>
            <div class="comment-item" v-for="(items,index) of comments" :key="index">
                ...
                <div class="item-p">
                    ...
                    <div class="item-content">
                      ...
                      <!-- 回复 -->
                      <div class="child-content" v-if="items.children.length>0">
                           <div v-for="(child,i) in items.children" :key="i"  v-if="i<10">
                    ...
                    <div class="item-footer">
                        ...
                        <span class="reply" @click="reply(items)">回复</span>
