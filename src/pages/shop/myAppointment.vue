  ...
  <div class="cl">
    <div class="appointment">
      ...
      <div class="appointment-product flex-r" v-if="isDetail">
        <div class="product-img"> <img :src="comm.commImg " :alt="comm.commName"></div>
        <div class="c flex-c product-title">
          <p class="c" style="font-size:13px;"> [{{comm.commName}}] {{comm.remark}}</p>
...
export default {
  ...
  methods: {
    ...
    goAndto() {
      if (this.isB == 1) {
        this.changeJump("../mineItem/myAppointment", {});
        this.isC = false;
      } else if (this.isB == 0) {
        this.isC == false;
      }
...
<style scoped>
/* @import url("//at.alicdn.com/t/font_834246_q02917kfa8.css"); */
.flex-r {
  display: flex;
  flex-direction: row;
}
