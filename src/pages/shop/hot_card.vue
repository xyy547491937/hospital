		...
		<div class="item" @click="jump">
			<div class="item-top">
				...
				<div class="info">
					...
					<div class="price">
						<span>
							<span class="price-span">¥{{ data.rulePrice }}</span>
							<span class="price-old">¥{{ data.price }}</span>
						</span>
					</div>
					<div class="count-c">
						<div class="active">
							<span v-if="data.isStage == 1" class="red">分</span>
							<span v-if="data.isInsurance == 1" class="green">保</span>
						</div>
						<p class="count-info">{{ data.buyNum }}人购买</p>
					</div>
				</div>
			</div>
		</div>
